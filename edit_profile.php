...
<br/>
			 ...
			 <table>
			 <tr align="center">
			  <td colspan="6"><h2 style="color:Black"><b>Edit Your Profile:</b></h2>
			  <br/>
<br/>
<br/>
<br/>
			  ...
			  <tr>
			  <td style="color:Black" align="right"><h3>Name:</h3></td>
			  <td>
			  ...
			  <tr>
			  <td style="color:Black" align="right"><h3>Email:</h3></td>
			  <td>
			  ...
			  <tr>
			  <td style="color:Black" align="right"><h3>Password:</h3></td>
			  <td>
			  ...
			  <tr>
			  <td style="color:Black" align="right"><h3>Photo:</h3></td>
			  <td>
