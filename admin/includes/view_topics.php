...
<?php 
              if(isset ($_GET['edit'])) {
				 ...
				 $sel="select * from topic where topic_id='$edit_id'";
				...
				<center><h2 style="padding: 5px;">Update the Topic</h2>
...
$run_update = mysqli_query($con,$run_update);
if($run_update){
...
$delete = "delete from topic where topic_id='$delete_id'";
