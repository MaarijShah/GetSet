...
<head>
    ...
    <link rel="stylesheet" href="SignUpCSS/css/g.css">
    <link rel="stylesheet" href="SignUpCSS/css/m.css">
            ...
            <div class="container">
                <div class="signup-content">
                    <form method="POST" id="signup-form" class="signup-form">
                        <center><img src="images/logo 222.png" width="90px" height="80px" alt="AVATAR"></center>
                        ...
                        <div class="form-group">
                            <input type="password" class="form-input" name="u_pass" id="password" placeholder="Password"/>
