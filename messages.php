...
<ul id="menu">
		...
		<br/>
		<br/>
		<img style="border-radius:60px;" src="users/<?php echo $user_image;?>" width='100' height='100'/>
			 <h2 style="color:Black">Send a message to: <span style='color:red;'><?php echo $user_name; ?></span></h2>
			 <br/>
			 ...
			 <p><strong><?php echo $user_name;?></strong> is the member of this site since:<?php echo $reg_date;?></p>
			</div>
		...
		$msg=$_POST['msg'];
		$insert="insert into messages (sender, receiver, msg_sub, msg_topic, reply,status, msg_date) values ('$user_id', '$u_id', '$msg_title', 
		'$msg','no reply','unread',NOW()) ";
		$run_insert= mysqli_query($con,$insert);
		
		if($run_insert){
			echo"<center><h2>Message has been sent to ".$user_name ." successfully</h2></center>";	
		}
		else {
			echo"<center><h2>Sending failed!</h2></center>";
		}
