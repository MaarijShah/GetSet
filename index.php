...
<!--===============================================================================================-->
	...
	<link rel="stylesheet" type="text/css" href="loginCSS/css/mm.css">
<!--===============================================================================================-->
</head>
<body>
	...
	<div class="limiter">
		...
		<div class="container-login100" style="background-image: url('images/new.jpg');">

			<div class="wrap-login100 p-t-190 p-b-30">
				<form action="" method="post" class="login100-form validate-form">
					<div class="login100-form-avatar">
						<img src="images/waqas.png" alt="AVATAR">
					</div>
					...
					<div class="text-center w-full">
						<a class="txt1" href="SignUp.php" style ="color:white; font-size:25px; ">
							<br/>
							Create new account
